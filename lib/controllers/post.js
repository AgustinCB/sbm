...
exports.default = {
  ...
  get: function get(req, res, next) {
    _post2.default.findById(req.params.post).then(function (post) {
      return res.status(200).json(post);
    }).catch(function (err) {
      return next(new _api_error2.default('Post not found', 404));
    });
  },
  ...
  update: function update(req, res, next) {
    ...
    _post2.default.findByIdAndUpdate(req.params.post, req.body).then(function (post) {
      ...
      return next(new _api_error2.default('Bad request', 404));
    });
  },
