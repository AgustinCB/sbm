...
var getType = function getType(value) {
  try {
    return { _id: _mongoose2.default.Types.ObjectId(value) };
  } catch (_) {
    return { title: value };
  }
};
...
exports.default = {
  ...
  get: function get(req, res, next) {
    _post2.default.findOne(getType(req.params.post)).populate('author').then(function (post) {
      return res.status(200).json(post);
    }).catch(function (err) {
      console.log(err);return next(new _api_error2.default('Post not found', 404, err));
    });
  },
