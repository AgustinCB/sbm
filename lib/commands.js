...
var read = exports.read = function read(args) {
  switch (args._[1]) {
    ...
    default:
      return _util.api.get('/' + args._[1] + '/' + args._[2]).then(function (res) {
        return res.body;
      });
  }
};
...
var create = exports.create = function create(args) {
  ...
  switch (args._[1]) {
    ...
    default:
      return _util.api.post('/' + args._[1], data).then(function (res) {
        return res.body;
      });
  }
};
...
var edit = exports.edit = function edit(args) {
  ...
  switch (args._[1]) {
    ...
    default:
      return _util.api.put('/' + args._[1] + '/' + args._[2], data).then(function (res) {
        return res.body;
      });
  }
};
...
var del = exports.del = function del(args) {
  switch (args._[1]) {
    ...
    default:
      return _util.api.delete('/' + args._[1] + '/' + args._[2]).then(function (res) {
        return res.body;
      });
  }
};