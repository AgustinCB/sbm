...
router.put('/user', authenticate, _user4.default.update);
router.delete('/user', authenticate, _user4.default.delete);

router.get('/post', _post2.default.list);
router.post('/post', authenticate, _post2.default.create);
router.put('/post', authenticate, _post2.default.update);
router.delete('/post', authenticate, _post2.default.delete);

router.get('/comment', _comment2.default.list);
router.post('/comment', authenticate, _comment2.default.create);
router.put('/comment', authenticate, _comment2.default.update);
router.delete('/comment', authenticate, _comment2.default.delete);
